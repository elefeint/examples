...
/**
 * Pub/Sub custom binder configuration; copied from PubSubBinderConfiguration directly.
 * The only change is returning {@code CustomPubSubMessageChannelBinder} instead of its superclass.
 */
@Configuration
@ConditionalOnMissingBean(Binder.class)
@EnableConfigurationProperties(PubSubExtendedBindingProperties.class)
public class CustomPubSubBinderConfiguration {
	...
	public PubSubMessageChannelBinder pubSubBinder(
		...
		return new CustomPubSubMessageChannelBinder(null, pubSubChannelProvisioner, pubSubTemplate,
